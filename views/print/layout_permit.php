...
.border-outer {
  position:absolute;
  left:6mm; top:6mm; right:6mm; bottom:6mm;
  border:1mm solid #caa33a;
}
.border-inner {
  position:absolute;
  left:9mm; top:9mm; right:9mm; bottom:9mm;
  border:0.35mm solid #caa33a;
}
...
<div class="page">
  ...
  <div class="sheet">
    <table class="hdr-table">
      <tr>
        <td width="75">
          <img src="<?= htmlspecialchars($imgBarangay) ?>" width="70" alt="Barangay Logo">
        </td>
        ...
        <td width="140" align="right">
          <img src="<?= htmlspecialchars($imgCity) ?>" width="60" style="margin-right:6px;" alt="City Logo">
          <img src="<?= htmlspecialchars($imgBagong) ?>" width="70" alt="Bagong Pilipinas">
        </td>
      </tr>
    </table>
