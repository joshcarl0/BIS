...
$buildAdminDashboardUrl = function (array $overrides = []) {
    $params = [
        'tx_page' => (int)($txPage ?? 1),
        'log_page' => (int)($logPage ?? 1),
    ];
    ...
    return '/BIS/controller/admin_dashboard.php?' . http_build_query($params);
};
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <small class="text-muted"><?= date('Y-m-d') ?> • Page <?= (int)($txPage ?? 1) ?> of <?= (int)($txTotalPages ?? 1) ?></small>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        <nav aria-label="Today transactions pagination">
                            <ul class="pagination pagination-sm mb-0">
                                <li class="page-item <?= (($txPage ?? 1) <= 1) ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?= htmlspecialchars($buildAdminDashboardUrl(['tx_page' => max(1, ($txPage ?? 1) - 1)])) ?>">Prev</a>
                                </li>
                                <li class="page-item disabled">
                                    <span class="page-link bg-light text-dark border-secondary-subtle"><?= (int)($txPage ?? 1) ?> / <?= (int)($txTotalPages ?? 1) ?></span>
                                </li>
                                <li class="page-item <?= (($txPage ?? 1) >= ($txTotalPages ?? 1)) ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?= htmlspecialchars($buildAdminDashboardUrl(['tx_page' => min((int)($txTotalPages ?? 1), (int)($txPage ?? 1) + 1)])) ?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="card shadow-sm mt-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <small class="text-muted">Page <?= (int)($logPage ?? 1) ?> of <?= (int)($logTotalPages ?? 1) ?></small>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        <nav aria-label="Recent activity pagination">
                            <ul class="pagination pagination-sm mb-0">
                                <li class="page-item <?= (($logPage ?? 1) <= 1) ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?= htmlspecialchars($buildAdminDashboardUrl(['log_page' => max(1, ($logPage ?? 1) - 1)])) ?>">Prev</a>
                                </li>
                                <li class="page-item disabled">
                                    <span class="page-link bg-light text-dark border-secondary-subtle"><?= (int)($logPage ?? 1) ?> / <?= (int)($logTotalPages ?? 1) ?></span>
                                </li>
                                <li class="page-item <?= (($logPage ?? 1) >= ($logTotalPages ?? 1)) ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?= htmlspecialchars($buildAdminDashboardUrl(['log_page' => min((int)($logTotalPages ?? 1), (int)($logPage ?? 1) + 1)])) ?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
